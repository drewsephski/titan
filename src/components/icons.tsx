...
export const Icons = {
  ...
  Discord: function Discord({
    ...
    return (
      ...
      >
        <path
          fill="currentColor"
          d="M20.32 4.37a19.8 19.8 0 0 0-4.88-1.53.07.07 0 0 0-.08.03c-.2.4-.45.96-.62 1.4a18.27 18.27 0 0 0-5.49 0 .1.1 0 0 0-.07-.02c-.2-.4-.42-.97-.62-1.4a.1.1 0 0 0-.08-.03A19.7 19.7 0 0 0 3.68 4.37a.1.1 0 0 0-.03.06 20.1 20.1 0 0 0-1.66 15.03.1.1 0 0 0 .06.07 19.9 19.9 0 0 0 5.35 2.65.1.1 0 0 0 .1-.04c.3-.4.57-.83.82-1.27a.1.1 0 0 0-.04-.14 13.13 13.13 0 0 1-1.82-.9.1.1 0 0 1-.01-.17c.12-.08.24-.16.35-.25.11-.08.22-.18.32-.26a.1.1 0 0 1 .11-.01 14.3 14.3 0 0 0 12.18 0 .1.1 0 0 1 .11.01c.11.08.22.18.33.26.11.09.23.17.35.25a.1.1 0 0 1 0 .17 13.13 13.13 0 0 1-1.83.9.1.1 0 0 0-.04.14c.25.44.53.87.82 1.27a.1.1 0 0 0 .1.04 19.9 19.9 0 0 0 5.35-2.65.1.1 0 0 0 .06-.07 20.1 20.1 0 0 0-1.66-15.03.1.1 0 0 0-.03-.06zM8.02 15.33c-1.18 0-2.16-1.1-2.16-2.43 0-1.34.96-2.43 2.16-2.43 1.2 0 2.17 1.1 2.17 2.43 0 1.33-.97 2.43-2.17 2.43zm7.95 0c-1.18 0-2.16-1.1-2.16-2.43 0-1.34.97-2.43 2.16-2.43 1.2 0 2.17 1.1 2.17 2.43 0 1.33-.97 2.43-2.17 2.43z"
        />
      </svg>
    );
  },
  Google: function Google({
    ...
    return (
      ...
      >
        <path
          fill="currentColor"
          d="M12.545 10.239v3.821h5.445c-0.712 2.315-2.647 3.972-5.445 3.972-3.332 0-6.033-2.696-6.033-6.031s2.701-6.031 6.033-6.031c1.498 0 2.866 0.549 3.921 1.453l2.814-2.814c-1.884-1.672-4.44-2.712-6.735-2.712-5.521 0-10 4.479-10 10s4.479 10 10 10c8.396 0 10-7.48 10-11.723 0-1.106-0.117-1.904-0.255-2.514h-9.745z"
        />
      </svg>
    );
  },
  ...
  // Document Icons
  bookOpen: (props: React.ComponentProps<"svg">) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      height="24"
  ...
  gitCommit: (props: React.ComponentProps<"svg">) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      height="24"
  ...
  // Sales/Support Icons
  sales: (props: React.ComponentProps<"svg">) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      height="24"
  ...
  newspaper: (props: React.ComponentProps<"svg">) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      height="24"
